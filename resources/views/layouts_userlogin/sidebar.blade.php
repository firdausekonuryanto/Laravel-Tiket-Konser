<ul class="nav nav-pills flex-column mb-auto">
    ...
    <li>
        <a href="/transaksi" class="nav-link {{($title === 'Halaman Pemesanan Tiket') ? 'active' : ''}} text-white">
            <svg class="bi pe-none me-2" width="16" height="16">
    ...
    @else
    <li>
        <a href="/semuapenonton" class="nav-link {{($title === 'Halaman Penonton') ? 'active' : ''}} text-white">
    ...
    <li>
        <a href="/validasitiket" class="nav-link {{($title === 'Halaman Validasi Tiket') ? 'active' : ''}} text-white">
            <svg class="bi pe-none me-2" width="16" height="16">
                <use xlink:href="#table" />
            </svg>
